...
def get_clustering_data(ratio=1.1):

    # n2 = int(ratio*600)
    circles = final_make_multiple_circles([
                                     {'c': [0,0], 'r': 1.0, 'n': 600},
                                     {'c': [2.05,0], 'r': 1.0, 'n': 1500}
                                    ], seed=None)

    # moons = final_make_interleaved_anuulus(ratio=1.0, w=0.25, b=0.42, n1=600, n2=1500, seed=None)

    # concentric = final_make_concentric(
    #                {'inner': 0, 'outer': 1.5, 'n':1250},
    #                {'inner': 1.65, 'outer': 2.0, 'n': 800}, seed=None
    #    )

    # concentric = final_make_concentric(
    #                {'inner': 0, 'outer': 1.5, 'n':1250},
    #                {'inner': 1.65, 'outer': 2.0, 'n': 1800}, seed=None
    #    )
