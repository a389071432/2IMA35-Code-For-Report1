...
def get_clustering_data(r2=1.5):
...
def affinity_clustering(adj, vertex_coordinates, plot_intermediate, num_clusters=2, plotter=None):
    ...
    while i < imax:
        ...
        plotter.plot_cluster(yhat, None, vertex_coordinates, i, leader, 'Results_buckets/two circles/fix_n/')
        # if len(graph)<30:
...
def main():
    ...
    # calcu accuracy score
    # print(yhats[-1])
    print('ACC:', calcu_acc(yhats[-1], dataset[0][1]))
