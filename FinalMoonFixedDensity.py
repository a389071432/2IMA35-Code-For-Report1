...
def get_clustering_data(size_ratio, seed):

    moons = final_make_interleaved_anuulus(ratio=size_ratio, w=0.25, b=0.45, n1=600, n2=int(600*size_ratio), seed=seed)
...
def main():
    ...
    for i in range(16):   
        ...
        size_ratio = 1 + 0.1 * i
        for k in range(20):
            dataset = get_clustering_data(size_ratio, seed=seeds[k])
        ...
        print(f'size_ratio = {size_ratio}, succ rate={succ/20}')
