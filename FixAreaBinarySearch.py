...
def get_clustering_data(n2, seed):
...
def main():
    ...
    seeds  = [1057142517, 1547905310, 150638261, 1184015999, 1220305740, 592933569, 1835325023, 1366467766, 796748167, 267472915, 720055956, 33950755, 662283339, 155879597, 719437072, 229956126, 1333240072, 954253822, 501530068, 1971358834, 1545259330, 1681777861, 2130101816, 513515885, 1214694088, 1661238396, 1471527061, 1623579914, 1377061228, 1080205204, 171802580, 2030230608, 136947588, 1914537629, 1911297726, 722527325, 629919183, 947339285, 772027100, 336046122, 1178755653, 350040802, 113372883, 258840583, 855652072, 691027101, 481897223, 1857373369, 1422369516, 1304462184]
    ...
    for seed in seeds:   
        ...
        # Binary search loop
        while RANGE >= 1 and L <= R:
            n2 = mid
            
            # Get and prepare dataset
            dataset = get_clustering_data(n2, seed)
